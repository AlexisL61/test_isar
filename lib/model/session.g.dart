...
const SessionSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'Candidat': CandidatSchema},
  getId: _sessionGetId,
...
int _sessionEstimateSize(
  ...
  bytesCount += 3 + object.candidates.length * 3;
  {
    final offsets = allOffsets[Candidat]!;
    for (var i = 0; i < object.candidates.length; i++) {
      final value = object.candidates[i];
      bytesCount += CandidatSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
void _sessionSerialize(
  ...
  writer.writeObjectList<Candidat>(
    offsets[0],
    allOffsets,
    CandidatSchema.serialize,
    object.candidates,
  );
...
Session _sessionDeserialize(
  ...
  object.candidates = reader.readObjectList<Candidat>(
        offsets[0],
        CandidatSchema.deserialize,
        allOffsets,
        Candidat(),
      ) ??
      [];
...
P _sessionDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectList<Candidat>(
            offset,
            CandidatSchema.deserialize,
            allOffsets,
            Candidat(),
...
extension SessionQueryFilter
  ...
  QueryBuilder<Session, Session, QAfterFilterCondition> candidatesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Session, Session, QAfterFilterCondition> candidatesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'candidates',
        0,
  ...
  QueryBuilder<Session, Session, QAfterFilterCondition> candidatesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'candidates',
        0,
  ...
  QueryBuilder<Session, Session, QAfterFilterCondition> candidatesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension SessionQueryObject
    on QueryBuilder<Session, Session, QFilterCondition> {
  QueryBuilder<Session, Session, QAfterFilterCondition> candidatesElement(
      FilterQuery<Candidat> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'candidates');
    });
  }
}
...
extension SessionQueryProperty
  ...
  QueryBuilder<Session, List<Candidat>, QQueryOperations> candidatesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'candidates');
    });
  }
